...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-4 col-md-offset-4" style="margin-top: 20px;">
            ...
            <div class="alert alert-danger alert-dismissible" role="alert" id="login_prompting" style="display: none;">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong>提示!</strong>&nbsp;&nbsp;<span id="login_prompting_message"></span>
            </div>
            ...
            <form action="javasctipr:void();" method="post" onsubmit="" enctype="">
                ...
                <button type="button" class="btn btn-success" id="login">&nbsp;登&nbsp;&nbsp;录&nbsp;</button>
